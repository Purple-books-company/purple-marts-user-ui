...
const DeliveryInformation = () =>{
    ...
    const save =() =>{
        if((details.pin.length<6 || details.pin.length>6) || (details.city==="" || details.state==="")){
             messages('err', 'Enter a valid pincode!')
            return;
        }
        if (details.fname==="" || details.lname==="" || details.phno==='' || details.address==="" || details.pin==="") {
        ...
        ApiPostService(process.env.REACT_APP_DELIVERYUPDATE, { 
            'customer': userId.id, 
