...
import { Badge, Card, CardImg, CardProductBottomDetails, CardProductDescription, CardProductName, CardProductOffer, CardProductOldprice, CardWishlist ,LabelforSize,Size,Shopcol,Shopcard,Shoplist,Shopbyprice,Shopbysize} from "../../../../styles/pages/category-styles";
const Card1 = () => { 
          ...
          <CardImg alt="Card image" className="card-img-top" variant="top" src={item.thumb} /></a>
                  <div className="card-block">
                    ...
                    <CardProductBottomDetails className="product-bottom-details">
                      ...
                      <CardWishlist id={id} href=""><FiHeart className={
                          toggleHeart ? 'heart active' : 'heart'
                        } onClick={() => HeartToggle(id)}/></CardWishlist>
  ...
  <div style={{boxSizing:'border-box',margin:'0 -5px'}} className="row">
    <Shopcol className="col-xs-12 col-md-4 col-lg-2">
      ...
      <Shoplist>
          <Size type='radio' value='100to200' name='radio' id='100to200' checked={radioPrice === "100to200"} onChange={(e)=>{SetRadioPrice(e.target.value)}}/>
    ...
    <Shopcol className="col-xs-12 col-md-4 col-lg-2">
      <Shopcard className="card">
      <Shoplist>
          <Size type='radio' value='200to300' name='radio'  id='200to300' checked={radioPrice === "200to300"} onChange={(e)=>{SetRadioPrice(e.target.value)}}/>
    ...
    <Shopcol className="col-xs-6 col-md-4 col-lg-2">
      <Shopcard className="card">
      <Shoplist>
          <Size type='radio' value='300to400' name='radio'  id='300to400' checked={radioPrice === "300to400"} onChange={(e)=>{SetRadioPrice(e.target.value)}}/>
    ...
    <Shopcol className="col col-xs-6 col-md-4 col-lg-2">
      <Shopcard className="card">
      <Shoplist>
          <Size type='radio' value='400to500' name='radio'  id='400to500' checked={radioPrice === "400to500"} onChange={(e)=>{SetRadioPrice(e.target.value)}}/>
  ...
  const ShopbySize = () => (
    <div style={{boxSizing:'border-box',margin:'0 -5px'}} className="row">
      <Shopcol className="col-xs-12 col-md-4 col-lg-2">
        <Shopcard className="card">
        <Shoplist>
            <Size type='radio' value='XXL' name='radio1' id='XXLarge' checked={radioSize === "XXL"} onChange={(e)=>{SetRadioSize(e.target.value)}}/>
      ...
      <Shopcol className="col-xs-12 col-md-4 col-lg-2">
        <Shopcard className="card">
        <Shoplist>
            <Size type='radio' value='Xl' name='radio1'  id='Xlarge' checked={radioSize === "Xl"} onChange={(e)=>{SetRadioSize(e.target.value)}}/>
      ...
      <Shopcol className="col-xs-6 col-md-4 col-lg-2">
        <Shopcard className="card">
        <Shoplist>
            <Size type='radio' value='L' name='radio1'  id='Large' checked={radioSize === "L"} onChange={(e)=>{SetRadioSize(e.target.value)}}/>
      ...
      <Shopcol className="col col-xs-6 col-md-4 col-lg-2">
        <Shopcard className="card">
        <Shoplist>
            <Size type='radio' value='S' name='radio1'  id='Small' checked={radioSize === "S"} onChange={(e)=>{SetRadioSize(e.target.value)}}/>
